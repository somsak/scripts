...
parser.add_argument('--url', dest = 'url', default = 'http://mon.byteark.com/zabbix', help = 'Zabbix server address')
parser.add_argument('-u', '--user', dest = 'user', default = 'admin', help = 'Zabbix user')
parser.add_argument('-p', '--password', dest = 'password', default = 'password', help = 'Zabbix password')
...
if host_list :
    result = zapi.graph.get({'hostids':host_list, 'search':{'name':args.graph}, 'output':'extend', 'searchWildcardsEnable': True})
else :
    result = zapi.graph.get({'search':{'name':args.graph}, 'output':'extend', 'searchWildcardsEnable': True})
